    ...
    <div className="container" style={{ paddingTop: 40, paddingBottom: 60 }}>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: 10 }}>Boost Your Custom Followers</h1>
        ...
        <div className="card" style={{ padding: 32, position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ marginBottom: 32 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 20 }}>
              <div>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 700, color: 'var(--text-secondary)' }}>Select Amount</h3>
                <p style={{ fontSize: '2.5rem', fontWeight: 900, color: 'var(--text-primary)', lineHeight: 1 }}>
          ...
          <div style={{ background: 'var(--bg-surface)', padding: 24, borderRadius: 12, display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24, border: '1px solid var(--border)' }}>
            <div>
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: 4 }}>Total Cost</p>
              <h2 style={{ fontSize: '2rem', fontWeight: 800 }}>₹{price.toLocaleString('en-IN')}</h2>
            </div>
            <div>
              <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', textAlign: 'right' }}>Rate</p>
