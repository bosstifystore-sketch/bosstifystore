...
export default function ProductDetail() {
  ...
  const images = product.images?.length ? product.images : ['https://placehold.co/600x450/13131f/7c3aed?text=DigiStore']
      ...
      <div className="product-detail-grid">
        ...
        <div className="product-images">
          <img
            ...
            onError={(e) => { (e.target as HTMLImageElement).src = 'https://placehold.co/600x450/13131f/7c3aed?text=DigiStore' }}
          />
          {images.length > 1 && (
