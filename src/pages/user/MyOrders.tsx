                ...
                <div style={{ display: 'flex', width: '100%', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 14, flex: 1 }}>
                    {details.image ? (
                      ...
                      <div style={{ width: 64, height: 64, borderRadius: 10, background: 'var(--bg-surface)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                        <Package size={24} style={{ color: 'var(--text-muted)' }} />
                      </div>
                    )}
                    <div className="order-card-info">
                      <p className="order-card-product">{details.title || 'Product'}</p>
